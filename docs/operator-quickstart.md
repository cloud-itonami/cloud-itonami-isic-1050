# Operator Quickstart — Dairy Processing Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1050** (`cloud-itonami-isic-1050`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1050.git
cd cloud-itonami-isic-1050
```
...
- Blueprint governor key: `dairy-governor`
- Likely source path: `dairyprocessing.governor.cljc`
